...
// JavaScript Document
        ...
        const imageData = [
            {
                title: "รูปบ้านเมืองที่ถูกทำลายจากพายุไต้ฝุ่นไห่เยี่ยน1",
                description: "แสดงถึงความเสียหายที่เกิดขึ้นกับบ้านเมืองจากพายุไต้ฝุ่นไห่เยี่ยน"
            },
            {
                title: "รูปหลังเหตุพายุไต้ฝุ่นไห่เยี่ยน",
                description: "แสดงถึงความเสียหายที่เกิดขึ้นหลังจากพายุไต้ฝุ่นไห่เยี่ยน"
            },
            {
                title: "รูปบ้านเมืองที่ถูกทำลายจากพายุไต้ฝุ่นไห่เยี่ยน2",
                description: "แสดงถึงความเสียหายที่เกิดขึ้นกับบ้านเมืองจากพายุไต้ฝุ่นไห่เยี่ยน"
            },
            {
                title: "รูปการเคลื่อนที่ของพายุไต้ฝุ่นไห่เยี่ยน",
                description: "แสดงถึงเส้นทางการเคลื่อนที่ของพายุไต้ฝุ่นไห่เยี่ยน"
            },
            {
                title: "รูปบ้านเมืองที่ถูกทำลายจากพายุไต้ฝุ่นไห่เยี่ยน3",
                description: "แสดงถึงความเสียหายที่เกิดขึ้นกับบ้านเมืองจากพายุไต้ฝุ่นไห่เยี่ยน"
            },
            {
                title: "ภาพถ่ายความสูญเสียทั่้งสัตว์และคน",
                description: "แสดงถึงความสูญเสียทั้งสัตว์และคนจากพายุไต้ฝุ่นไห่เยี่ยน"
            },
            {
                title: "รูปพายุไต้ฝุ่นไห่เยี่ยน",
                description: "แสดงถึงภาพถ่ายดาวเทียมของพายุไต้ฝุ่นไห่เยี่ยน"
            }
        ];
